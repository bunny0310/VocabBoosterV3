...
for (const word of words) {
    ...
    const morphedWord = Object.assign(Object.assign({}, word), { types: mappedTypes, "_id": { "$oid": new bson_1.ObjectID().toString() }, user: { "$oid": "626f1aa4a722baa33988c0d8" }, createdAt: { "$date": date }, updatedAt: { "$date": date } });
...
(0, fs_1.writeFile)('./morphedWords.json', bigString, () => {
});
