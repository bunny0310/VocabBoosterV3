...
4. In a seperate terminal window, fire up the words API on the port 5002. Ensure that the port number is not being used by any other application. Cd into `dotnet/words` and run the command `dotnet run --urls=http://localhost:5001/`.
